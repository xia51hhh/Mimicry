    ...
    <div v-else class="profile-list">
      ...
      >
        ...
        <div class="profile-actions">
          ...
          <button class="btn-icon-xs btn-danger" :title="t('profile.delete')" @click.stop="confirmDelete(p.id)">
            <Trash2 :size="12" />
          </button>
        </div>
      </div>
      ...
      <div v-if="deleteConfirmId" class="modal-overlay" @click="deleteConfirmId = null">
        <div class="modal-box" @click.stop>
          ...
          <div class="modal-actions">
            <button class="btn btn-secondary" @click="deleteConfirmId = null">{{ t('profile.cancel') }}</button>
