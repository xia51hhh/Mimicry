      ...
      <div class="dialog-box" :style="{ colorScheme: isDark ? 'dark' : 'light' }" @click.stop>
        ...
        <div class="form-fields">
          ...
          <div class="form-group">
            ...
            <input v-model="bc.startup_url" class="form-input" placeholder="https://..." />
          </div>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.headless }"
                @click="bc.headless = !bc.headless"
              >
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.geoip }"
                @click="bc.geoip = !bc.geoip"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.block_webrtc }"
                @click="bc.block_webrtc = !bc.block_webrtc"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.block_webgl }"
                @click="bc.block_webgl = !bc.block_webgl"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: humanizeEnabled }"
                @click="humanizeEnabled = !humanizeEnabled"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.block_images }"
                @click="bc.block_images = !bc.block_images"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <div class="form-group">
            <label class="form-label form-label-row">
              ...
              <button
                class="toggle-btn"
                :class="{ active: bc.enable_cache }"
                @click="bc.enable_cache = !bc.enable_cache"
              >
                <span class="toggle-dot" />
              </button>
            </label>
          ...
          <template v-if="showAdvanced">
            <div class="form-group">
              <label class="form-label form-label-row">
                ...
                <button
                  class="toggle-btn"
                  :class="{ active: bc.disable_coop }"
                  @click="bc.disable_coop = !bc.disable_coop"
                >
                  <span class="toggle-dot" />
                </button>
              </label>
            ...
            <div class="form-group">
              ...
              <input
                ...
                @change="
                  bc.args = ($event.target as HTMLInputElement).value.split(/\s+/).filter(Boolean)
                "
              />
            </div>
          </template>
          ...
          <div v-if="profile && form.user_data_dir" class="form-group">
            ...
            <input :value="form.user_data_dir" class="form-input readonly" readonly />
          </div>
        </div>
