...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::browser::workflow_pause,
            commands::browser::workflow_unpause,
            commands::browser::workflow_step,
            commands::browser::workflow_inject,
            commands::browser::workflow_set_breakpoint,
            commands::browser::workflow_remove_breakpoint,
            commands::browser::workflow_list_breakpoints,
            commands::browser::workflow_state,
            commands::browser::selector_start_picking,
            commands::browser::selector_stop_picking,
            commands::browser::selector_get_picked,
            commands::browser::selector_analyze,
            commands::browser::selector_test,
            commands::browser::selector_highlight,
