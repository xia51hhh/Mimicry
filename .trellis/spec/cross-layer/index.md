...
- [parallel-development.md](parallel-development.md) — Worktree placement, branch naming, hot-file ownership, merge order, and forbidden patterns for parallel agent development
